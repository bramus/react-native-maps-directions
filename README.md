...
| `splitWaypoints` | `boolean` | `false` | Directions API has [limit](https://developers.google.com/maps/documentation/directions/usage-and-billing#directions-advanced) of 10 or 25 (depends on the billing plan) waypoints per route. So waypoints array size is limited to those numbers. Set this to true if you would like to automatically split waypoints to multiple routes and by that avoid waypoints limit.
